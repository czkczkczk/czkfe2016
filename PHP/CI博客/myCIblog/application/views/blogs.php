...
<ul>
	<li class="caption">博客管理	
		<ol>
			...
			<li class="current"><a href="user/blogList">文章管理</a></li>
...
<div class="MainForm BlogArticleManage">
  <h3 class="title">共有 <?php echo count($blogList) ;?> 篇博客，每页显示 40 个，共 1 页</h3>
    <div id="BlogOpts">
  ...
  <ul>
	  <?php
		  ...
		  {
			  echo "<li class=\"row_1\"> <input name=\"blog\" value=\"$row->blog_id\" type=\"checkbox\">
						<a href=\"viewPost_comment.htm\" target=\"_blank\">$row->title</a>
                         -$row->type_name
